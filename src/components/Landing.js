    ...
    <>
      ...
      <div className="flex flex-row space-x-4 items-start px-4 py-4">
        ...
        <div className={classnames(
          "focus:outline-none w-[25%] border-2 border-black z-10 rounded-md shadow-[5px_5px_0px_0px_rgba(0,0,0)] px-4 py-2 hover:shadow transition duration-200 bg-gray-300 mt-2"
        )}>
